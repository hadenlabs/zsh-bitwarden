...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-bitwarden``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-bitwarden )`` to your list of
   plugins
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/luismayta/zsh-bitwarden/readme
   :target: https://github.com/luismayta/zsh-bitwarden
